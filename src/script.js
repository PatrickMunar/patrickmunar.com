...
const textArray = [
    ['Hello',
    "<t class='smallText'> I'm <t class='mainColor'>Patrick Munar</t><br>a <t class='Lobster mainColor'>Creative Developer</t> & <t class='Roboto mainColor'>Engineer</t> from the Philippines.</t></t>",
    ...
    '<t class="smallestText">Made a ton of fun memories with the University of the Philippines Flag Football Club</t><br><br><ul>Usual Positions <t class="mainColor">:</t><li class="smallestText">MLB</li><li class="smallestText">Slot Receiver</li>'],
